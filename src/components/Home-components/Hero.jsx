...
const Hero = () => {
  return (
    <header className="relative w-full py-16 md:py-24 lg:py-32 bg-primary overflow-hidden">
      ...
      <div className="layout-container relative z-10 px-4 md:px-10 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        <div className="flex-1 text-center md:text-left space-y-6">
          ...
          <p className="text-blue-100 text-lg md:text-xl font-medium max-w-2xl mx-auto md:mx-0 leading-relaxed">
            Compassionate behavioral therapy empowering children and families to
            thrive. We create a supportive environment for every unique journey.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start pt-4">
            <button className="h-12 px-8 rounded-lg  bg-orange-400 hover:bg-orange-500 hover:-translate-y-0.5 duration-300 text-white font-bold text-base shadow-lg hover:shadow-xl transition-all flex items-center justify-center cursor-pointer gap-2">
              Get Started
              <span className="material-symbols-outlined text-lg">
                <FaLongArrowAltRight />
              </span>
            </button>
            <button className="h-12 px-8 rounded-lg bg-white/10 hover:bg-white/20 border hover:-translate-y-0.5 duration-300 cursor-pointer border-white/30 text-white font-bold text-base backdrop-blur-sm transition-all ">
              Learn More
            </button>
          </div>
        </div>
              ...
              <div className="bg-white/95 backdrop-blur p-4 rounded-xl shadow-lg flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-xs">
                    Based on recent family feedback surveys
                  </p>
                </div>
              </div>
            </div>
