    ...
    <section className="relative py-20 overflow-hidden bg-primary">
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-10 z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          {/* Left Column */}
          <div>
            <h2 className="text-white font-bold text-lg uppercase tracking-wide mb-2">
              Why Choose Us
            </h2>
            ...
            <p className="text-white/80 text-lg mb-8">
              We know that choosing a therapy provider is a big decision. At
              Special Effects, we combine clinical excellence with a heart for
              service.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 mt-1">
                    Our team consists of Board Certified Behavior Analysts
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 mt-1">
                    No two children are alike. We create custom treatment plans
                    tailored specifically to your child's strengths and needs.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/80 mt-1">
                    We offer therapy in your home, at our center, or in
                    community settings depending on what works best for
                    learning.
                  </p>
                </div>
              </div>
