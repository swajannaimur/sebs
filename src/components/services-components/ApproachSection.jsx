  ...
  return (
    <section className="px-6 py-16 lg:px-20 bg-white">
      <div className="max-w-[960px] mx-auto text-center">
        <h2 className="text-[#1E3A8A] text-3xl font-bold leading-tight mb-8">
          Our Care Approach
        </h2>
        <div className="grid sm:grid-cols-3 gap-8">
          {approaches.map((approach) => {
            ...
            return (
              ...
              >
                <div className="size-14 rounded-full flex items-center justify-center mb-2 bg-white border-2 border-orange-400 transition-all duration-300 group-hover:border-[#1E3A8A]">
                  <Icon className="text-3xl text-orange-400 transition-all duration-500 group-hover:text-[#1E3A8A] cursor-pointer" />
                </div>
