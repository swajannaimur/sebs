        ...
        <div className="grid sm:grid-cols-3 gap-8">
          {approaches.map((approach) => {
            ...
            return (
              ...
              >
                <div className="size-14 rounded-full flex items-center justify-center mb-2 bg-white border-2 border-[#1E3A8A] group-hover:border-orange-400 transition-all duration-300 ">
                ...
                <p className="text-[#475569] text-[16px] leading-normal">
