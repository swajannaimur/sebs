        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 flex flex-col gap-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-orange-500 text-xl font-bold">Age Groups Served</h3>
            </div>

            <ul className="space-y-3">
              {[
                { label: 'Toddlers (2-5):', desc: 'Early intervention focus' },
                { label: 'School Age (6-12):', desc: 'Social & academic support' },
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 flex flex-col gap-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-orange-500 text-xl font-bold">Therapy Settings</h3>
            </div>

            <ul className="space-y-3">
              {[
                { label: 'In-Clinic:', desc: 'Structured learning environment' },
