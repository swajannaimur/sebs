      ...
      <div className="relative z-10 py-20">
        ...
        <div className="max-w-[1280px] mx-auto px-4 md:px-10 grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 
            transition-all duration-300 ease-out 
            hover:scale-[1.05] hover:-translate-y-2 hover:shadow-lg">
            <div className="w-14 h-14 rounded-xl bg-orange-100 text-accent flex items-center justify-center mb-6 
              transition-transform duration-500 hover:rotate-[20deg] hover:scale-110">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-3">Family-Centered</h3>
            <p className="text-slate-600 leading-relaxed">
