      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7 bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200">
          ...
          <p className="text-slate-600 text-sm sm:text-base mb-6">
            Please fill out the form below. Your information is kept
            confidential.
          </p>
          ...
          <form className="space-y-5">
            ...
            <select className="w-full rounded-lg border-2 border-slate-300 px-4 py-3 text-sm focus:outline-none focus:border-orange-400 focus:border-2">
